...
export function AppHeader() {
  return (
    <header
      className='flex shrink-0 items-center justify-center md:justify-start z-30 bg-[color:var(--color-primary)] shadow-[var(--shadow-sm)] px-3 sm:px-4 md:px-6 pt-[env(safe-area-inset-top)] min-h-[calc(52px+env(safe-area-inset-top))] lg:min-h-[calc(60px+env(safe-area-inset-top))]'
      id='nav-header'>
